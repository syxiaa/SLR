...
keys = ['anneal', 'credit', 'heart1', 'hepatitis', 'horse', 'iono',
                'wdbc', 'zoo','wine','lymphography']
# keys = ['wine']
classifiers = ['BP', 'KNN', 'SVM', 'CART', 'LR', 'xgboost','GBDT','lightgbm']
# keys=['german', 'heart2','wine']
for d in range(len(keys)):
    ...
    re=rough_set_attribute(data,Equivalence_class)